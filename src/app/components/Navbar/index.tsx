...
export default function Navbar(req: any) {
  ...
  return (
    <div className="flex w-full align-center justify-center md:justify-start lg:justify-start p-5 gap-5 text-sm bg-slate-800 sticky top-0 z-10 tracking-tight">
      <Link
        href="/"
