...
export default function Navbar({ navbarTranslations }: Props) {
  const { about, experience, projects, social } = navbarTranslations;

  return (
    <div
      className="align-center sticky top-0 z-10 flex w-full items-center justify-center gap-5 
     bg-slate-300 p-5 text-sm tracking-tight text-slate-600 md:justify-start dark:bg-slate-700 dark:text-lime-600
      "
    >
      <Link
        href="/"
